<script>
	...
	onMount(() => {
		...
		if ($ThemeStore.theme == 'dark' || ($ThemeStore.theme == 'system' && darkThemeMq)) {
		...
		window.$('#rss-feeds').rss('http://medium.com/feed/@bashamtg', {
			...
			// valid values: any string
			entryTemplate:
				'<div class="item"><h3 class="title"><a href="{url}" target="_blank">{title}</a></h3><div><p>{shortBodyPlain}</p><a class="more-link" href="{url}" target="_blank"><i class="fas fa-external-link-alt"></i>Read more <span class="sr-only">about this blog post</span></a></div></div>'
		});
		// rss.render();
			...
			<div class="col-12 col-md-auto">
				<div class="dark-mode-switch d-flex">
					<div class="form-check form-switch mx-auto mx-md-0">
						<input
							on:input={() => setTheme($ThemeStore.theme == 'dark' ? 'light' : 'dark')}
							type="checkbox"
				...
				<!--//dark-mode-switch-->
				<a class="btn btn-cta-primary" href="#contact-me"
				...
				<div class="section-inner shadow-sm rounded">
					...
					<div class="content">
						...
						<div class="item row">
							...
							<div class="desc col-md-8 col-12">
								<h3 class="title">Music API - A Full Stack API for storing royalty free music</h3>
								<p class="mb-2">
									Music API is a powerful Full Stack web application that allows users to store
									royalty-free music easily. Built using Django Rest Framework, PostgreSQL,
									Paginator, Wavsurfer.js, Cloudinary Storage, and WebAudio-Controls, this API
									provides a complete solution for storing, managing, and playing back music tracks.
									With the API's integration of Cloudinary Storage, users can efficiently store and
									retrieve multimedia files. Wavsurfer.js provides a user-friendly interface for
									visualizing audio, paired with WebAudio-Controls, it offers an excellent option
						...
						<div class="item row">
							...
							<div class="desc col-md-8 col-12">
								<h3 class="title">
									Trails API - A simple way to store your favorite hiking trails.
								</h3>
								<p class="mb-2">
									Trails API is a Full-Stack Django Rest Framework API designed for storing and
									managing favorite hiking trails. Once users log in, they can add a trail by simply
									pasting a link from WTA.org, where the data is scraped to build the map. The API
									is built with Django Rest Framework, PostgreSQL, Pandas, Folium, and Beautiful
									Soup. PostgreSQL is used as the database management system, while Pandas is
									utilized for data manipulation. Folium is a powerful Python library that's
									employed to create maps, and Beautiful Soup is used for web scraping.
								</p>
								<p>
									<a
										class="more-link me-4"
					...
					<div class="content">
						...
						<div class="item">
							...
							<p>
								...
								that translate well to software development.
							</p>
						</div>
						<div class="item">
							<h3 class="title">
							...
							<p>
								...
								over $800,000 of work/repairs annually on commercial buildings. I resolved
								maintenance issues and managed equipment worth over $60,000, ensuring efficiency and
								proper maintenance. My critical problem-solving skills enabled me to complete all
								requests, while my leadership abilities ensured a smooth operation. Overall, my
								experience demonstrates my ability to lead and manage resources effectively, skills
								that will translate well into software development.
							</p>
						</div>
						...
						<div class="item">
							...
							<p>
								...
								and vehicles to support combat operations. I also trained and mentored team members
								on combat tactics and techniques, demonstrating my leadership abilities and
								dedication to mission success. Throughout my service, effective communication was
								crucial, and I consistently communicated with team members and superiors to ensure
								mission objectives and goals were clear. My experience as a Calvary Scout in the US
								Army highlights my ability to operate complex equipment, train and mentor others,
								and communicate effectively. These skills will translate well into software
								development, where effective communication, leadership, and problem-solving are also
								essential.
							</p>
						</div>
					</div>
				...
				<div class="section-inner shadow-sm rounded">
					...
					<div class="content">
						<ul class="list-unstyled">
							...
							<li>
								<i class="fas fa-envelope" /><span class="sr-only">Email:</span><a
									href="mailto: bashamtg@gmail.com">bashamtg@gmail.com</a
								>
							</li>
							<li>
								<i class="fas fa-link" /><span class="sr-only">Website:</span><a
									href="https://www.linkedin.com/in/thomas-basham">linkedin.com/in/thomas-basham</a
								>
							</li>
						</ul>
					</div>
				...
				<div class="section-inner shadow-sm rounded">
					...
					<div class="content">
						<p class="intro">
							...
							am proficient in JavaScript and React, and have experience managing and maintaining
							SQL and NoSQL databases, as well as experience using CSS tools such as Bootstrap,
							Tailwind, and Material UI. My knowledge of HTML5, CSS3, and SASS is also advanced,
							making me a versatile developer who can handle a variety of projects.
						</p>
				...
				<div class="section-inner shadow-sm rounded">
					...
					<div class="content">
						...
						<div class="item">
							...
							<h4 class="university">
								Icon Collective College of Music <span class="year">(2020-2021)</span>
							</h4>
						</div>
					</div>
					<!--//content-->
					...
					<div class="content">
						<ul class="list-unstyled">
							<li class="item">
								...
								<span class="level"
									>Native Speaker <br class="visible-xs" /><i class="fas fa-star" />
				...
				<div class="section-inner shadow-sm rounded">
					...
					<div class="content">
						<ul class="list-unstyled pb-2">
							...
							<li>
								<a href="https://fontawesome.com" target="_blank" rel="noreferrer nofollow"
							...
							<li>
								<a
									...
									target="_blank"
									rel="noreferrer nofollow"><i class="fas fa-external-link-alt" />Vanilla RSS</a
								>
							</li>
							<li>
								<a href="https://github.com/beynar/svelte-themes" rel="noreferrer nofollow"
					...
					<div class="content">
						<ul class="list-unstyled pb-2">
							<li>
								...
								<span class="sr-only">Email: </span><a href="mailto: bashamtg@gmail.com">
									bashamtg@gmail.com</a
								>
							</li>
							<li>
								<i class="fas fa-phone" />
								<span class="sr-only">Phone: </span><a href="tel: 2532582526"> 253-258-2526</a>
							</li>
						</ul>
						<div id="contact-me">
							{#if showForm}
							...
							{/if}
							{#if !showForm}
								<div>Thanks For your message. I will respond as soon as I can!</div>
							{/if}
						</div>
					</div>
					<!--//content-->
...
<footer class="footer">
	<div class="container text-center">
		...
		<small class="copyright"
			...
			by
			<a href="https://themes.3rdwavemedia.com" target="_blank" rel="noreferrer nofollow"
				>Xiaoying Riley</a
